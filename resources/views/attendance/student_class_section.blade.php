...
<div class="">
    <div class="">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="mb-0">
                {{ __('messages.class_section_details') }}: 
                <span class="text-primary">
                    {{ $classSection->grade->school->name }} - {{ $classSection->grade->name }} - {{ $classSection->name }} 
                    [ {{ $classSection->grade->academicYear->name }} ]
                </span>
            </h2>
            <div class="d-flex">
            ...
            <div class="row">
                ...
                <div class="mb-4 col-md-3">
                    ...
                    <div class="form-control bg-light">
                        {{ $currentTerm->name ?? __('messages.no_current_term') }}
                    </div>
                </div>
            </div>
...
$(document).ready(function () {
    ...
    if (!termId) {
        console.warn('لا يوجد فصل دراسي حالي، لن يتم إرسال أي بيانات.');
        return;
    }
